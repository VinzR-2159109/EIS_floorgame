...
public class CalibrationClass
{
    ...
    {
        public Matrix3D groundPlaneTransform;
        public Emgu.CV.Matrix<double> transform;

        public CalibrationData(Matrix3D groundPlaneTransform, Matrix<double> transform)
        {
            this.groundPlaneTransform = groundPlaneTransform;
    ...
    public CalibrationData Data => new CalibrationData(m_groundPlaneTransform, m_transform!);

    public CalibrationClass(KinectSensor kinectSensor) => m_kinectSensor = kinectSensor;
    public CalibrationClass(KinectSensor kinectSensor, CalibrationData calibrationData)
    {
        m_kinectSensor = kinectSensor;
        m_groundPlaneTransform = calibrationData.groundPlaneTransform;
        m_transform = calibrationData.transform;
    }
