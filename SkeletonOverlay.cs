...
namespace floorgame
{
    public class SkeletonOverlay
    {
        private readonly Canvas SkeletonOverlayCanvas;
        private readonly KinectSensor kinectSensor;

        public SkeletonOverlay(Canvas canvas, KinectSensor sensor)
        {
            SkeletonOverlayCanvas = canvas;
            kinectSensor = sensor;
        }
        ...
        public void DrawSkeleton(Skeleton skeleton)
        {
            ...
            SkeletonOverlayCanvas.Children.Clear();
        ...
        private void DrawJoint(Joint joint)
        {
            ...
            double x = (point.X / 640.0) * SkeletonOverlayCanvas.ActualWidth;
            double y = (point.Y / 480.0) * SkeletonOverlayCanvas.ActualHeight;
            ...
            SkeletonOverlayCanvas.Children.Add(jointEllipse);
        }
        ...
        private void DrawBone(Skeleton skeleton, JointType jointType1, JointType jointType2)
        {
            ...
            if (joint1.TrackingState == JointTrackingState.Tracked && joint2.TrackingState == JointTrackingState.Tracked)
            {
                ...
                DepthImagePoint point1 = kinectSensor.CoordinateMapper.MapSkeletonPointToDepthPoint(joint1.Position, DepthImageFormat.Resolution640x480Fps30);
                DepthImagePoint point2 = kinectSensor.CoordinateMapper.MapSkeletonPointToDepthPoint(joint2.Position, DepthImageFormat.Resolution640x480Fps30);

                // Scale the coordinates to the Canvas size
                double x1 = (point1.X / 640.0) * SkeletonOverlayCanvas.ActualWidth;
                double y1 = (point1.Y / 480.0) * SkeletonOverlayCanvas.ActualHeight;
                double x2 = (point2.X / 640.0) * SkeletonOverlayCanvas.ActualWidth;
                double y2 = (point2.Y / 480.0) * SkeletonOverlayCanvas.ActualHeight;
                ...
                SkeletonOverlayCanvas.Children.Add(boneLine);
            }
        }
        ...
        private void DrawHandCircle(Skeleton skeleton, JointType handType)
        {
            ...
            if (hand.TrackingState == JointTrackingState.Tracked)
            {
                ...
                SkeletonOverlayCanvas.Children.Add(handCircle);
            }
        }
